...
import { 
  ...
  Lightbulb, Leaf, MapPin, Phone, Mail, Quote
} from 'lucide-react';
...
const clientBrandsData: ClientBrand[] = [
  {
    id: 'ihg',
    name: 'IHG Hotels & Resorts',
    category: 'Global Franchise Partner',
    description: 'Holiday Inn Express, Staybridge Suites & Candlewood Suites operational management and brand QA compliance.',
    badge: 'Franchise QA Certified',
    metrics: '98.5% Brand QA Score'
  },
  {
    id: 'choice',
    name: 'Choice Hotels',
    category: 'Brand Distribution Partner',
    description: 'Comfort Inn & Suites, Quality Inn & MainStay extended-stay revenue optimization and day-to-day operations.',
    badge: 'Preferred Operator',
    metrics: '115% RevPAR Index'
  },
  {
    id: 'wyndham',
    name: 'Wyndham Hotels & Resorts',
    category: 'Brand Stewardship',
    description: 'La Quinta, Baymont & Days Inn full-service operations, housekeeping standards, and dynamic rate yield.',
  ...
  },
  {
    ...
    category: 'Select Service Partner',
    description: 'Best Western Plus & Premier property turnaround, guest satisfaction index, and cost containment.',
    badge: 'Operational Partner',
    metrics: '+22% NOI Growth'
  },
  {
    id: 'boutique-independent',
    name: 'Independent & Boutique Assets',
    category: 'Private Ownership Portfolios',
    description: 'Bespoke hotel management, direct booking engine optimization, unique guest experiences, and asset positioning.',
    badge: 'Custom Scope',
    metrics: 'Top 5% Guest Ratings'
  },
  {
    id: 'institutional-reit',
    name: 'Real Estate Investment Trusts & Family Offices',
    category: 'Equity & Asset Management',
    description: 'Fiduciary asset management, CapEx allocation, financial reporting, and long-term asset valuation appreciation.',
    badge: 'Fiduciary Alignment',
    metrics: 'Complete Fiduciary Trust'
  }
];
...
const testimonialsData: TestimonialItem[] = [
  {
    ...
    company: 'Lone Star Hospitality Capital',
    quote: 'Las Colinas transformed our property’s RevPAR index within the first two quarters. Their operational rigor, transparent accounting, and fiduciary mindset make them our premier hotel management partner.',
    rating: 5,
    stat: '+28%',
    statLabel: 'RevPAR Index Increase'
  },
  {
    id: 't2',
    author: 'Sarah Jenkins',
    title: 'Principal',
    company: 'Apex Hotel Equity Group',
    quote: 'From pre-opening staffing to strict brand QA audits, the Las Colinas executive team delivered exceptional results, reduced labor turnover, and significantly maximized our bottom-line NOI.',
    rating: 5,
    stat: '100%',
    statLabel: 'Brand QA Audit Score'
  },
  {
    id: 't3',
    author: 'David Ross',
    title: 'Managing Director',
    company: 'Texas Heritage Asset Fund',
    quote: 'Transparent monthly reporting, aggressive OTA yield management, and direct executive access with zero bureaucracy. They treat our hotel assets as if it were their own equity.',
    rating: 5,
    stat: '+18.4%',
    statLabel: 'Net Operating Income'
  }
];
